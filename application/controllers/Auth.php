...
class Auth extends CI_Controller 
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            ...
            // cek password   
                ...
                $this->session->set_flashdata('message','<div class="alert alert-danger" role="alert">This email is not active </div>');
                redirect('auth');
            }
        } else {
    ...
    {       
            ...
            if ($this->form_validation->run() == false){
                $data['title']  = 'PGT Garahan Registration' ;
                $this->load->view('templates/auth_header', $data);
